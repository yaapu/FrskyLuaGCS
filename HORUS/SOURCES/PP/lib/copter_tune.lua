...
local parameters = {
  ...
  -- row 2
  {"ATC_RAT_RLL_P"        , 0.01, 0.5, 0.005        , x=X_COLUMN_1,y=MIN_Y+43,label="P"},
  {"ATC_RAT_RLL_I"        , 0.01, 2.0, 0.01         , x=X_COLUMN_1,y=MIN_Y+59,label="I"},
  {"ATC_RAT_RLL_D"        , 0.0, 0.05, 0.001        , x=X_COLUMN_1,y=MIN_Y+75,label="D"},
  {"ATC_RAT_RLL_IMAX"     , 0, 1, 0.01              , x=X_COLUMN_1,y=MIN_Y+91,label="IMAX"},
  --{"ATC_RAT_RLL_FILT"   ,  1, 50, 1               , x=X_COLUMN_1,y=MIN_Y+107,label="FILT"},
  
  {"ATC_RAT_PIT_P"        , 0.01, 0.5, 0.005        , x=X_COLUMN_2,y=MIN_Y+43,label="P"},
  {"ATC_RAT_PIT_I"        , 0.01, 2.0, 0.01         , x=X_COLUMN_2,y=MIN_Y+59,label="I"},
  {"ATC_RAT_PIT_D"        , 0.0, 0.05, 0.001        , x=X_COLUMN_2,y=MIN_Y+75,label="D"},
  {"ATC_RAT_PIT_IMAX"     , 0, 1, 0.01              , x=X_COLUMN_2,y=MIN_Y+91,label="IMAX"},
  --{"ATC_RAT_PIT_FILT"   ,  1, 50, 1               , x=X_COLUMN_2,y=MIN_Y+107,label="FILT"},
  
  {"ATC_RAT_YAW_P"        , 0.1, 2.5, 0.005         , x=X_COLUMN_3,y=MIN_Y+43,label="P"},
  {"ATC_RAT_YAW_I"        , 0.01, 1.0, 0.01         , x=X_COLUMN_3,y=MIN_Y+59,label="I"},
  ...
  -- row 4
  {"AUTOTUNE_AXES"        , {"All","Roll","Ptch","Yaw","R+P","R+Y","P+Y"}, {7,1,2,4,3,5,6}, x=X_COLUMN_2,y=MIN_Y+184,label="Axis"},
