...
local soundFileBasePath = "/SCRIPTS/TOOLS/YaapuGCS/sounds"
...
local function drawWarning(text)
  ...
  lcd.drawText(130, 130, "Yaapu LuaGCS ".."1.2.0 dev ("..'de4a4dc'..")", SMLSIZE+CUSTOM_COLOR)
end
...
local function drawStatusBar(status,telemetry,model,gpsStatuses)
  ...
  if telemetry.statusArmed == 1 then
    ...
    lcd.setColor(CUSTOM_COLOR,lcd.RGB(00, 0xED, 0x32))
  ...
  -- yaw
  lcd.setColor(CUSTOM_COLOR,lcd.RGB(138,138,138))
